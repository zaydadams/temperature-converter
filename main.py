...
labelfr_1 = LabelFrame(root, text="Degrees Celsius", padx=48, pady=48)
labelfr_1.pack(fill="both")
labelfr_1 .place(x=20, y=10)
entryfr_1 = Entry(labelfr_1, state="disable")
entryfr_1.pack()

labelfr_2 = LabelFrame(root, text="Degrees fahrenheit", padx=48, pady=48)
...
entryfr_1_btn = Button(root, text="Activate-Fahrenheit to Celsius", command=active_1)
entryfr_1_btn.pack()
entryfr_1_btn.place(x=20, y=150)


def active_1():
    if len(entryfr_1.get()) > 0:
...
entryfr_2_btn = Button(root, text="Activate-Celsius to Fahrenheit", command=active_1)
entryfr_2_btn.pack()
